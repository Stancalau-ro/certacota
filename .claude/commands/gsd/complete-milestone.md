...
- @C:/Mergebine/certacota/.claude/get-shit-done/workflows/complete-milestone.md (main workflow)
- @C:/Mergebine/certacota/.claude/get-shit-done/templates/milestone-archive.md (archive template)
  </execution_context>
