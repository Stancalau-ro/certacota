...
<required_reading>
@C:/Mergebine/certacota/.claude/get-shit-done/references/common-bug-patterns.md
</required_reading>
...
@C:/Mergebine/certacota/.claude/get-shit-done/references/debugger-philosophy.md
...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = C:/Mergebine/certacota/.claude
                  → checks C:/Mergebine/certacota/.claude/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = C:/Mergebine/certacota/.claude/get-shit-done
                  → writes to C:/Mergebine/certacota/.claude/get-shit-done/hooks/
...
@C:/Mergebine/certacota/.claude/get-shit-done/references/thinking-models-debug.md
...
- Read @C:/Mergebine/certacota/.claude/get-shit-done/references/common-bug-patterns.md
