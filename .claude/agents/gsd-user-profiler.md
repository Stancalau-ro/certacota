...
<reference>
@C:/Mergebine/certacota/.claude/get-shit-done/references/user-profiling.md
...
Read the user-profiling reference document at `C:/Mergebine/certacota/.claude/get-shit-done/references/user-profiling.md` to load:
