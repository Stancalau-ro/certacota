...
Use template from `C:/Mergebine/certacota/.claude/get-shit-done/templates/UI-SPEC.md`.
...
Read template: `C:/Mergebine/certacota/.claude/get-shit-done/templates/UI-SPEC.md`
