...
Reference full template: `C:/Mergebine/certacota/.claude/get-shit-done/templates/roadmap.md`

## STATE.md Structure

Use template from `C:/Mergebine/certacota/.claude/get-shit-done/templates/state.md`.
