...
<!-- For checkpoint task examples and patterns, see @C:/Mergebine/certacota/.claude/get-shit-done/references/checkpoints.md -->
...
See `C:/Mergebine/certacota/.claude/get-shit-done/references/tdd.md` for TDD plan structure.
...
See `C:/Mergebine/certacota/.claude/get-shit-done/templates/user-setup.md` for full schema and examples
...
See `C:/Mergebine/certacota/.claude/get-shit-done/workflows/verify-phase.md` for verification logic.
