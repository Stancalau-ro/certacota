...
```markdown
Read C:/Mergebine/certacota/.claude/agents/gsd-ui-researcher.md for instructions.
...
Template: C:/Mergebine/certacota/.claude/get-shit-done/templates/UI-SPEC.md
</output>
...
```markdown
Read C:/Mergebine/certacota/.claude/agents/gsd-ui-checker.md for instructions.
