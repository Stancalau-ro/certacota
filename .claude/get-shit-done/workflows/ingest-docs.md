...
```bash
INIT=$(node "C:/Mergebine/certacota/.claude/get-shit-done/bin/gsd-tools.cjs" init ingest-docs)
...
```bash
node "C:/Mergebine/certacota/.claude/get-shit-done/bin/gsd-tools.cjs" commit \
