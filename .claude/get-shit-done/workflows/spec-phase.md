...
```bash
INIT=$(node "C:/Mergebine/certacota/.claude/get-shit-done/bin/gsd-tools.cjs" init phase-op "${PHASE}")
...
Use the SPEC.md template from @C:/Mergebine/certacota/.claude/get-shit-done/templates/spec.md.
