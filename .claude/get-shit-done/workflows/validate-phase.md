...
```
Agent(
  prompt="Read C:/Mergebine/certacota/.claude/agents/gsd-nyquist-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `C:/Mergebine/certacota/.claude/get-shit-done/templates/VALIDATION.md`
