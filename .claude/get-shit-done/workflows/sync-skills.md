...
INSTALL_JS_GLOBAL="C:/Mergebine/certacota/.claude/get-shit-done/bin/install.js"
...
error: source skills root not found: <path>
       ...
       Run: node C:/Mergebine/certacota/.claude/get-shit-done/bin/install.js --global --<runtime>
```
Then exit.
