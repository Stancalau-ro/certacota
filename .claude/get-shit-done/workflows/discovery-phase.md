...
See C:/Mergebine/certacota/.claude/get-shit-done/templates/discovery.md `<discovery_protocol>` for full protocol.
</source_hierarchy>
...
6. **Create DISCOVERY.md** using C:/Mergebine/certacota/.claude/get-shit-done/templates/discovery.md structure:
...
1. **Scope the discovery** using C:/Mergebine/certacota/.claude/get-shit-done/templates/discovery.md:
...
6. **Create comprehensive DISCOVERY.md:**
   ...
   - Full structure from C:/Mergebine/certacota/.claude/get-shit-done/templates/discovery.md
...
Use C:/Mergebine/certacota/.claude/get-shit-done/templates/discovery.md.
